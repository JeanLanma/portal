  ...
  <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
    <thead class="bg-gray-50">
      <tr>
        ...
        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Tecnico</th>
    ...
    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
      ...
      <tr v-for="ticket in props.tickets" :key="ticket.id" class="hover:bg-gray-50">
        <th class="pl-4 py-4">
            {{ ticket.ticket_id }}
        </th>
        <td class="flex gap-3 px-6 py-4 font-normal text-gray-900">
          <div class="text-sm">
            <div class="font-medium text-gray-700">{{ ticket.customer.customer }}</div>
            <div class="text-gray-400">de: {{ ticket.request_of }}</div>
          </div>
        </td>
        <td class="px-6 py-4">
          <span
        ...
        <td class="px-6 py-4">{{ ticket.user.full_name }}</td>
        <td class="px-6 py-4">
            <!-- {{ ticket.created_at.slice(0, 19)  }} -->
